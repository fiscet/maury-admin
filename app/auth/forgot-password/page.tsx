    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6">
      <div className="w-full max-w-lg animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-black text-slate-900 tracking-tight italic mb-2">Recupera Accesso</h1>
          <p className="text-slate-500 font-medium">Inserisci la tua email per reimpostare la password</p>
        </div>

        <div className="card-premium">
          {message && (
            <div className={`p-5 mb-10 rounded-2xl flex items-start gap-3 animate-in fade-in slide-in-from-top-2 duration-300 ${message.type === 'success'
          ...
          <form onSubmit={handleReset} className="space-y-10">
            <div className="space-y-4">
              <label className="label-premium">Email Amministratore</label>
