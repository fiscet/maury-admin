    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-6 selection:bg-primary/20 selection:text-primary">
      <div className="w-full max-w-lg animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="card-premium">
          {error && (
            <div className="mb-8 p-4 bg-rose-50 border border-rose-100 rounded-xl text-rose-600 text-sm font-bold flex items-center gap-3 animate-in shake-in duration-300">
          ...
          <form onSubmit={handleLogin} className="space-y-8">
            <div className="space-y-3">
              <label className="label-premium">Indirizzo Email</label>
        ...
        <p className="text-center mt-12 text-[10px] font-bold text-slate-400 uppercase tracking-[0.2em]">
          &copy; {new Date().getFullYear()} HM Management. SISTEMA PROTETTO.
        </p>
      </div>
    </div>
  );
